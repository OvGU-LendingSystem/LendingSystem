...
def test_tag_filter(client, test_db):
    ...
    result = str(executed)
    print(result)
    shouldbe = "{'data': {'filterTags': [{'name': 'Game', 'physicalobjects': {'edges': []}}, {'name': 'Cooking', 'physicalobjects': {'edges': []}}, {'name': 'Hardware', 'physicalobjects': {'edges': []}}]}}"
    msg = "Filter with NO Input params failed"
    assert(result == shouldbe), msg
    ...
    result = str(executed)
    print(result)
    shouldbe = "{'data': {'filterTags': [{'name': 'Game', 'physicalobjects': {'edges': []}}]}}"
