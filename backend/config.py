...
if hostname == "hades":
    app.config[
        'SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://' + db_user + ':' + db_pw + '@localhost/' + db_database
elif ((int)(config.get('TESTING', 'testing'))):
    app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///:memory:'
else:
    app.config[
        'SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://' + db_user + ':' + db_pw + '@hades.fritz.box:3306/' + db_database
CORS(app, resources={r"/*": {"origins": "*"}})
